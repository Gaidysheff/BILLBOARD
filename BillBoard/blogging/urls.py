...
from .views import (AddBlog, AllFeedbacksList, DeleteBlog, FeedbackAccept,
                    FeedbackCreate, FeedbackDelete, FeedbackList,
                    FeedbackReject, FeedbacksList, LoginUser, PostsHome,
                    PostsInCategory, UpdateBlog, about, contact, show_post)
...
urlpatterns = [
    ...
    path('<slug:post_slug>/create_feedback',
         FeedbackCreate.as_view(), name='feedback_create'),
    ...
    path('feedbacks/', AllFeedbacksList.as_view(), name='feedbacks_all'),
