...
from .views import (AddBlog, DeleteBlog, FeedbackAccept, FeedbackCreate,
                    FeedbackDelete, FeedbackList, FeedbackReject,
                    FeedbacksList, LoginUser, PostsHome, PostsInCategory,
                    UpdateBlog, about, contact, show_post)
...
urlpatterns = [
    ...
    path('<slug:post_slug>/create_feedback', FeedbackCreate.as_view(), name='feedback_create'),
